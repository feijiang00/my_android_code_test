package com.example.helloworld.view.clock;
...
public class MyClockView extends View {
    ...
    private void initAttribute(Context context, AttributeSet attributeSet){
        ...
        clockHColor=typedArray.getColor(R.styleable.MyClockView_clockHColor, Color.GREEN);
        clockMColor=typedArray.getColor(R.styleable.MyClockView_clockMColor, Color.YELLOW);
    ...
    private void drawScaleNumber(Canvas canvas){
        ...
        clockScaleNumberPaint.setColor(R.color.purple_200);
        Rect rect=new Rect();
    ...
    private void drawTimeNumber(Canvas canvas){
        ...
        clockTimeNumberPaint.setColor(Color.BLUE);
    ...
    /**
     * 这里将时钟的启动抽象出来，之前的时钟都是在init中自己定义一个线程开始绘图，这样不好
     */
    public void start(){
